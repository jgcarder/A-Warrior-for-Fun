...
namespace A_Worrior_For_Fun
{
    ...
    public class Level1
    {
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            var source5 = new Rectangle(20 * 16, 3 * 16, 32, 32);
            var source6 = new Rectangle(33 * 16, 10 * 16, 16, 16);
            spriteBatch.Draw(texture, new Vector2(100 - 48, 250 - 48), source5, Color.DarkSlateBlue, 0f, new Vector2(), 2f, SpriteEffects.None, 0);
            spriteBatch.Draw(texture, new Vector2(100 - 32, 250 - 32), source6, Color.White, 0f, new Vector2(), 2f, SpriteEffects.None, 0);
